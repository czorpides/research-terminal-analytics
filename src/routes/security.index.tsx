  ...
  return (
    <AppShell>
      ...
      <div className="rounded-md border border-border/70 bg-card/40">
        <div className="grid grid-cols-[80px_minmax(0,1fr)_100px_60px_60px_60px_80px_100px] items-center border-b border-border/70 px-3 py-1.5 font-mono text-[10px] uppercase tracking-wider text-muted-foreground">
          <div>Symbol</div>
          <div>Name</div>
          <div>Industry</div>
        ...
        {rows.length === 0 ? (
          ...
          <Link
            ...
            className="grid grid-cols-[80px_minmax(0,1fr)_100px_60px_60px_60px_80px_100px] items-center border-b border-border/60 px-3 py-1.5 text-[12px] transition-colors hover:bg-muted/40 last:border-b-0"
          >
      ...
      <div className="mt-3 font-mono text-[10px] text-muted-foreground">
        {rows.length} securities · sorted by composite (momentum, trend, volatility)
      </div>
    </AppShell>
  );
}