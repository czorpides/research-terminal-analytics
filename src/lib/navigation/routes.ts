...
export const ROUTES: RouteEntry[] = [
  ...
  { id: "ma-in",   path: "/macro/inflation",    name: "Inflation Engine", group: "macro", icon: Gauge,        stage: 2, status: "planned",        enabled: true,  requiredDataSources: ["fred","ons","eurostat"], requiredModels: ["kalman.llt","pca"], purpose: "Headline vs core, goods vs services, wage-pass-through decomposition." },
