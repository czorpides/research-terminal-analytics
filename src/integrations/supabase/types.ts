...
export type Database = {
  ...
  public: {
    ...
    Enums: {
      ...
      asset_class:
        "equity" | "etf" | "bond" | "commodity" | "fx" | "crypto" | "index" | "future" | "option";
      data_category:
        | "macro_release"
        | "price_daily"
        | "price_intraday"
      ...
      source_tier: "tier1_official" | "tier2_regulated" | "tier3_reputable" | "tier4_alternative";
      subject_type:
        "asset" | "industry" | "country" | "commodity" | "factor" | "indicator" | "thesis";
      thesis_state: "active" | "strengthening" | "weakening" | "broken" | "archived";
    };
    CompositeTypes: {
      [_ in never]: never;
    };
...
export const Constants = {
  public: {
    Enums: {
      ...
      ingestion_status: ["pending", "running", "success", "partial", "failed"],
      source_tier: ["tier1_official", "tier2_regulated", "tier3_reputable", "tier4_alternative"],
      subject_type: ["asset", "industry", "country", "commodity", "factor", "indicator", "thesis"],
      thesis_state: ["active", "strengthening", "weakening", "broken", "archived"],
    },
  },
} as const;
