-- Phases 4 and 5: US Labour Engine, Market Engine and shadow Regime Monitor.
-- All external series are public FRED mirrors. PCA/HMM artifacts are stored as
-- shadow diagnostics until stability review; transparent scores remain live.
